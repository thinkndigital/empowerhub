...
type CoachProfile = { id: string; name?: string; email?: string; bio?: string; specializations?: string; role?: string };
...
export default function CoachProfilePage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    const [pRes, bRes, sRes] = await Promise.all([
      ...
      fetch(`/api/org/users?role=beneficiary&coachId=${params.id}`, { headers: { authorization: `Bearer ${token}` } }),
