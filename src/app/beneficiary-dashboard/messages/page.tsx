...
export default function MessagesPage() {
  ...
  return (
    <div className="container mx-auto p-4 h-[calc(100vh-80px)]" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row gap-4 h-[calc(100%-60px)]">
        <Card className="w-full sm:w-80 flex-shrink-0 flex flex-col max-h-64 sm:max-h-full">
