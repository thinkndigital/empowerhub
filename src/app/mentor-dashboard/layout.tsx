...
import {
  ...
  MessageSquare, Calendar, BarChart3, LogOut,
} from "lucide-react";
      ...
      <Sidebar side="right">
        <SidebarHeader className="border-b border-sidebar-border">
          <div className="flex items-center gap-3 px-3 py-4">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-xs text-sidebar-foreground">لوحة تحكم المرشد</span>
            </div>
          </div>
        </SidebarHeader>
        <SidebarContent>
        ...
        <SidebarFooter className="border-t border-sidebar-border p-2">
          ...
          <SidebarMenuButton asChild tooltip="الإعدادات">
            <Link href="/mentor-dashboard/settings"><Settings /><span>الإعدادات</span></Link>
          </SidebarMenuButton>
        </SidebarFooter>
      </Sidebar>
      <SidebarInset>
          ...
          <div className="flex items-center gap-1">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                {authUser ? (
                  <>
                    <DropdownMenuItem onSelect={() => router.push('/mentor-dashboard/settings')} className="text-right cursor-pointer">الإعدادات</DropdownMenuItem>
                    <DropdownMenuSeparator />
