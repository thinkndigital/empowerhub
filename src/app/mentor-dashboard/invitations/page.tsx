  ...
  const handleAccept = async (inv: OrgInvitation) => {
    ...
    try {
      ...
      await addDoc(collection(firestore, "notifications"), {
        userId: inv.orgId,
        title: "قبول دعوة",
        body: `${userProfile?.name ?? "مرشد"} قبل دعوتك للانضمام إلى المنظمة`,
        read: false,
        createdAt: serverTimestamp(),
        link: "/organization-dashboard/mentors",
      });
  ...
  const handleReject = async (inv: OrgInvitation) => {
    ...
    try {
      ...
      await addDoc(collection(firestore, "notifications"), {
        userId: inv.orgId,
        title: "رفض دعوة",
        body: `${userProfile?.name ?? "مرشد"} رفض دعوتك للانضمام إلى المنظمة`,
        read: false,
        createdAt: serverTimestamp(),
        link: "/organization-dashboard/mentors",
      });
